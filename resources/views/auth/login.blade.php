        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">{{ __('Bienvenue') }}! 👋</h4>
              <p class="mb-4">{{ __('Veuillez vous connecter à votre compte')}}</p>
              

              <form id="formAuthentication" class="mb-3" action="{{route('login')}}" method="post"> @csrf
                <div class="mb-3">
                  <label for="email" class="form-label">{{ __('Email or N° téléphone') }}</label>
                  <input
                    type="text"
                    class="form-control @error('email_phone') is-invalid @enderror"
                    id="email"
                    name="email_phone"
                    placeholder="{{ __('Enter your email or N° téléphone') }}"
                    autofocus
                  />
              ...
              <p class="text-center">
                <span>{{ __("Vous n'avez de compte ?")}}</span>
