@extends('backend.partials._template')
  @section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Abonnement et Facturation / </span>Moyens de paiement</h4>
    ...
    <div class="buy-now">
      <a href="{{url('/paiements/methode/ajouter')}}" class="btn btn-danger btn-buy-now"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="bx bx-credit-card me-1"></i> Ajouter un moyen de paiement</font></font></a>
    </div>
