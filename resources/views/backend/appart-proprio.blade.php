@extends('backend.partials._template')
  @section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Appartements du propriétaire {{ucfirst($proprietaire->name)}}</span></h4>
      <hr class="my-5" />
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item" href="
                            {{ route('agence.appart.details',[config('app.locale'),$appart->code_appart]) }}

                          {{-- route('agence.appart.edit',[config('app.locale'),$appart->code_appart]) --}}"
