...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Proprietaire {{$proprietaire->reference}} /</span>Modifier</h4>

  <!-- Basic Layout -->
  <form id="editProprioForm" action="#" enctype="multipart/form-data" method="post"> @csrf
    <div class="row">
      <div class="col-xxl">
        <div class="card mb-4">
          ...
          <div class="card-body">
              ...
              <div class="mb-3">
                <div class="row">
                  <input type="hidden" name="reference" value="{{$proprietaire->reference}}">
                  <div class="col-md-6">
                  ...
                  <select
                      ...
                      >
                        @foreach($countries as $pays)
                          <option {{$proprietaire->country_id == $pays->id ? 'selected' : ' '}} value="{{$pays->id}}">{{$pays->name}}</option>
                        @endforeach
              ...
              <button type="submit" class="btn btn-info update_proprietaire" data-bs-toggle="tooltip"
                        data-bs-offset="0,4"
