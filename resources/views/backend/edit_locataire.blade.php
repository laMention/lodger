...
<div class="container-xxl flex-grow-1 container-p-y">
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Locataire {{$locataire->reference}} /</span>Modifier</h4>

  <!-- Basic Layout -->
  <form id="editLocataireForm" action="#" enctype="multipart/form-data" method="post"> @csrf
    <div class="row">
      <div class="col-xxl">
        <div class="card mb-4">
          ...
          <div class="card-body">
              ...
              <div class="mb-3">
                <div class="row">
                  <input type="hidden" name="reference" value="{{$locataire->reference}}">
                  <div class="col-md-6">
                  ...
                  <select
                      ...
                      >
                        @foreach($countries as $pays)
                          <option {{$locataire->country_id == $pays->id ? 'selected' : ' '}} value="{{$pays->id}}">{{$pays->name}}</option>
                        @endforeach
              ...
              <button type="submit" class="btn btn-info update_locataire" data-bs-toggle="tooltip"
                        data-bs-offset="0,4"
                        data-bs-placement="top"
                        data-bs-html="true"
                        title="<i class='bx bx-plus bx-xs' ></i> <span>Enregistrer ce Propriétaire</span>">Enregistrer</button>
              <a type="button" href="{{route('agence.locataires.index',[config('app.locale')])}}" class="btn btn-primary" data-bs-toggle="tooltip"
                        data-bs-offset="0,4"
                        data-bs-placement="top"
                        data-bs-html="true"
                        title="<i class='bx bx-eye bx-xs' ></i> <span>Afficher la liste des Propriétaires</span>">Liste des locataires</a>
