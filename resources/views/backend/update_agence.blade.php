              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                        ...
                        <div class="button-wrapper">
                          <form id="uploadedAvatarAgenceForm" method="POST" enctype="multipart/form-data">
                            <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                              <span class="d-none d-sm-block">Télécharger un logo</span>
                            ...
                            <button type="button" class="btn btn-outline-secondary account-image-reset mb-4 btn_uploadAvatarAgence" style="display:none;">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formUpdateAgenceSettings" method="POST" enctype="multipart/form-data">
                        <div class="row">
                          ...
                          <span class="error_agrement"></span>
                          </div>
                          <div class="mb-3 col-md-6">
                        ...
                        <div class="mt-2">
                          <button type="submit" class="btn btn-primary me-2 btn_updateInfos">{{__('Enregistrer')}}</button>
