@extends('frontend.partials._template')
  @section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Suggestions / </span>Suggestions</h4>
      <hr class="my-5" />
    ...
    <div class="buy-now">
      <a href="{{url('/locataire/suggestions/nouveau')}}" class="btn btn-danger btn-buy-now"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Envoyer une suggestion</font></font></a>
    </div>
