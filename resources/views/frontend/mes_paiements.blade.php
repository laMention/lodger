@extends('frontend.partials._template')
  @section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Loyer / </span>Mes paiements</h4>
      <hr class="my-5" />
    ...
    <div class="buy-now">
      <a href="{{url('/paiements/methode/ajouter')}}" class="btn btn-primary btn-buy-now"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="bx bx-credit-card me-1"></i> Ajouter un moyen de paiement</font></font></a>
    </div>
